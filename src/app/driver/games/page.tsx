...
export default function GamesMenuPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0b0c15] text-white">
            {/* Header */}
            <div className="bg-[#151621] border-b border-gray-800 p-4 flex items-center gap-4 sticky top-0 z-10">
                <Link href="/driver/dashboard" className="p-2 -ml-2 hover:bg-gray-800 rounded-full transition-colors">
            ...
            <main className="p-4 max-w-lg mx-auto space-y-6 pt-8">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">Relájate unos minutos antes de volver a la ruta.</p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white mb-1">Snake</h3>
                    ...
                    >
                        ...
                        <div className="relative z-10 flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-white mb-1">Pac-Man</h3>
